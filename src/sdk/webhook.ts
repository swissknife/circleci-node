...
export class Webhook extends ClientSDK {
  ...
  async createWebhook(
    ...
    return unwrapAsync(webhookCreateWebhook(
      this,
      request,
      options,
    ));
  ...
  async deleteWebhook(
    ...
    return unwrapAsync(webhookDeleteWebhook(
      this,
      request,
      options,
    ));
  ...
  async getWebhookById(
    ...
    return unwrapAsync(webhookGetWebhookById(
      this,
      request,
      options,
    ));
  ...
  async getWebhooks(
    ...
    return unwrapAsync(webhookGetWebhooks(
      this,
      request,
      options,
    ));
  ...
  async updateWebhook(
    ...
    return unwrapAsync(webhookUpdateWebhook(
      this,
      request,
      options,
    ));
