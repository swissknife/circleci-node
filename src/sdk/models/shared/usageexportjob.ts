...
/** @internal */
export const UsageExportJobState$inboundSchema: z.ZodNativeEnum<
  typeof UsageExportJobState
> = z.nativeEnum(UsageExportJobState);

/** @internal */
export const UsageExportJobState$outboundSchema: z.ZodNativeEnum<
  typeof UsageExportJobState
...
/** @internal */
export const UsageExportJob$inboundSchema: z.ZodType<
  UsageExportJob,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function usageExportJobToJSON(usageExportJob: UsageExportJob): string {
  return JSON.stringify(UsageExportJob$outboundSchema.parse(usageExportJob));
}

export function usageExportJobFromJSON(
  jsonString: string,
): SafeParseResult<UsageExportJob, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UsageExportJob$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UsageExportJob' from JSON`,
  );
}
