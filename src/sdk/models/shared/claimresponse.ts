...
/** @internal */
export const ClaimResponse$inboundSchema: z.ZodType<
  ClaimResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  audience: z.array(z.string()).optional(),
  audience_updated_at: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ).optional(),
  org_id: z.string(),
  project_id: z.string().optional(),
  ttl: z.string().optional(),
  ttl_updated_at: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  audience: z.array(z.string()).optional(),
  audienceUpdatedAt: z.date().transform(v => v.toISOString()).optional(),
  orgId: z.string(),
  projectId: z.string().optional(),
  ttl: z.string().optional(),
  ttlUpdatedAt: z.date().transform(v => v.toISOString()).optional(),
}).transform((v) => {
  return remap$(v, {
