...
export namespace RerunWorkflowRerunWorkflowParameters$ {
  ...
  export const inboundSchema =
    RerunWorkflowRerunWorkflowParameters$inboundSchema;
  /** @deprecated use `RerunWorkflowRerunWorkflowParameters$outboundSchema` instead. */
  export const outboundSchema =
    RerunWorkflowRerunWorkflowParameters$outboundSchema;
...
export const RerunWorkflowRequest$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  RequestBody: z.lazy(() => RerunWorkflowRerunWorkflowParameters$inboundSchema)
    .optional(),
  id: z.string(),
}).transform((v) => {
  return remap$(v, {
...
export const RerunWorkflowRequest$outboundSchema: z.ZodType<
  ...
  RerunWorkflowRequest
> = z.object({
  requestBody: z.lazy(() => RerunWorkflowRerunWorkflowParameters$outboundSchema)
    .optional(),
  id: z.string(),
}).transform((v) => {
  return remap$(v, {
