 ...
 * The type of checkout key. This may be either `deploy-key` or `github-user-key`.
 */
export type ListCheckoutKeysCheckoutKeyType = ClosedEnum<
...
/** @internal */
export const Digest$inboundSchema: z.ZodNativeEnum<typeof Digest> = z
  .nativeEnum(Digest);

/** @internal */
export const Digest$outboundSchema: z.ZodNativeEnum<typeof Digest> =
...
/** @internal */
export const CheckoutKey$inboundSchema: z.ZodType<
  CheckoutKey,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export namespace ListCheckoutKeysCheckoutKeyListResponse$ {
  ...
  export const inboundSchema =
    ListCheckoutKeysCheckoutKeyListResponse$inboundSchema;
  /** @deprecated use `ListCheckoutKeysCheckoutKeyListResponse$outboundSchema` instead. */
  export const outboundSchema =
    ListCheckoutKeysCheckoutKeyListResponse$outboundSchema;
