...
/** @internal */
export const CheckoutKeyInputType$inboundSchema: z.ZodNativeEnum<
  typeof CheckoutKeyInputType
> = z.nativeEnum(CheckoutKeyInputType);

/** @internal */
export const CheckoutKeyInputType$outboundSchema: z.ZodNativeEnum<
  typeof CheckoutKeyInputType
...
export namespace CreateCheckoutKeyCheckoutKeyInput$ {
  ...
  export const outboundSchema =
    CreateCheckoutKeyCheckoutKeyInput$outboundSchema;
...
export const CreateCheckoutKeyRequest$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  RequestBody: z.lazy(() => CreateCheckoutKeyCheckoutKeyInput$inboundSchema)
    .optional(),
...
export const CreateCheckoutKeyRequest$outboundSchema: z.ZodType<
  ...
  CreateCheckoutKeyRequest
> = z.object({
  requestBody: z.lazy(() => CreateCheckoutKeyCheckoutKeyInput$outboundSchema)
    .optional(),
...
/** @internal */
export const CheckoutKeyType$inboundSchema: z.ZodNativeEnum<
  typeof CheckoutKeyType
> = z.nativeEnum(CheckoutKeyType);

/** @internal */
export const CheckoutKeyType$outboundSchema: z.ZodNativeEnum<
  typeof CheckoutKeyType
