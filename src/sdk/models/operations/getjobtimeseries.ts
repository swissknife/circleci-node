...
export namespace GetJobTimeseriesInsightsResponseBody$ {
  ...
  export const inboundSchema =
    GetJobTimeseriesInsightsResponseBody$inboundSchema;
  /** @deprecated use `GetJobTimeseriesInsightsResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    GetJobTimeseriesInsightsResponseBody$outboundSchema;
...
export const GetJobTimeseriesItems$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  max_ended_at: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ),
  metrics: z.lazy(() => GetJobTimeseriesMetrics$inboundSchema),
  min_started_at: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ),
  name: z.string(),
