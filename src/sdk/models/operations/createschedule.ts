 ...
 * Day in a week, in three letters format
 */
export type CreateScheduleDaysOfWeek = ClosedEnum<
 ...
 * Day in a week, in three letters format
 */
export type CreateScheduleScheduleDaysOfWeek = ClosedEnum<
 ...
 * Month, in three letters format.
 */
export type CreateScheduleScheduleMonths = ClosedEnum<
 ...
 * Timetable that specifies when a schedule triggers.
 */
export type CreateScheduleTimetable =
...
/** @internal */
export const AttributionActor$inboundSchema: z.ZodNativeEnum<
  typeof AttributionActor
> = z.nativeEnum(AttributionActor);

/** @internal */
export const AttributionActor$outboundSchema: z.ZodNativeEnum<
  typeof AttributionActor
...
/** @internal */
export const CreateScheduleMonths$inboundSchema: z.ZodNativeEnum<
  typeof CreateScheduleMonths
> = z.nativeEnum(CreateScheduleMonths);

/** @internal */
export const CreateScheduleMonths$outboundSchema: z.ZodNativeEnum<
  typeof CreateScheduleMonths
...
/** @internal */
export const CreateSchedule2$inboundSchema: z.ZodType<
  CreateSchedule2,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const Months$inboundSchema: z.ZodNativeEnum<typeof Months> = z
  .nativeEnum(Months);

/** @internal */
export const Months$outboundSchema: z.ZodNativeEnum<typeof Months> =
  Months$inboundSchema;
...
/** @internal */
export const CreateSchedule1$inboundSchema: z.ZodType<
  CreateSchedule1,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const Timetable$inboundSchema: z.ZodType<
  Timetable,
  z.ZodTypeDef,
  unknown
> = z.union([
...
/** @internal */
export type Timetable$Outbound =
  | CreateSchedule1$Outbound
  | CreateSchedule2$Outbound;

/** @internal */
export const Timetable$outboundSchema: z.ZodType<
  Timetable$Outbound,
  z.ZodTypeDef,
  Timetable
> = z.union([
...
export namespace CreateScheduleCreateScheduleParameters$ {
  ...
  export const inboundSchema =
    CreateScheduleCreateScheduleParameters$inboundSchema;
  /** @deprecated use `CreateScheduleCreateScheduleParameters$outboundSchema` instead. */
  export const outboundSchema =
    CreateScheduleCreateScheduleParameters$outboundSchema;
...
/** @internal */
export type CreateScheduleScheduleParameters$Outbound =
  | number
  | string
  | boolean;
...
/** @internal */
export const CreateScheduleScheduleResponseDaysOfWeek$inboundSchema:
  z.ZodNativeEnum<typeof CreateScheduleScheduleResponseDaysOfWeek> = z
    .nativeEnum(CreateScheduleScheduleResponseDaysOfWeek);

/** @internal */
export const CreateScheduleScheduleResponseDaysOfWeek$outboundSchema:
  z.ZodNativeEnum<typeof CreateScheduleScheduleResponseDaysOfWeek> =
...
export namespace CreateScheduleScheduleResponseDaysOfWeek$ {
  ...
  export const outboundSchema =
    CreateScheduleScheduleResponseDaysOfWeek$outboundSchema;
}

/** @internal */
export const CreateScheduleScheduleResponseMonths$inboundSchema:
  z.ZodNativeEnum<typeof CreateScheduleScheduleResponseMonths> = z.nativeEnum(
    CreateScheduleScheduleResponseMonths,
  );

/** @internal */
export const CreateScheduleScheduleResponseMonths$outboundSchema:
  z.ZodNativeEnum<typeof CreateScheduleScheduleResponseMonths> =
...
export namespace CreateScheduleScheduleResponseMonths$ {
  ...
  export const outboundSchema =
    CreateScheduleScheduleResponseMonths$outboundSchema;
}
...
> = z.object({
  "days-of-month": z.array(z.number().int()),
  "days-of-week": z.array(
    CreateScheduleScheduleResponseDaysOfWeek$inboundSchema,
  ).optional(),
  "hours-of-day": z.array(z.number().int()),
  months: z.array(CreateScheduleScheduleResponseMonths$inboundSchema)
    .optional(),
  "per-hour": z.number().int(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  daysOfMonth: z.array(z.number().int()),
  daysOfWeek: z.array(CreateScheduleScheduleResponseDaysOfWeek$outboundSchema)
    .optional(),
  hoursOfDay: z.array(z.number().int()),
  months: z.array(CreateScheduleScheduleResponseMonths$outboundSchema)
    .optional(),
  perHour: z.number().int(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  "updated-at": z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ),
}).transform((v) => {
  return remap$(v, {
