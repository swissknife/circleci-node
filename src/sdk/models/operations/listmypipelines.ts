 ...
 * The type of trigger.
 */
export type ListMyPipelinesPipelineType = ClosedEnum<
...
export type ListMyPipelinesTriggerParameters =
  | ListMyPipelines4
  | string
  | number
  | boolean;
...
export type ListMyPipelinesPipeline = {
  ...
  triggerParameters?: {
    [k: string]: ListMyPipelines4 | string | number | boolean;
  } | undefined;
  /**
...
/** @internal */
export const ListMyPipelinesType$inboundSchema: z.ZodNativeEnum<
  typeof ListMyPipelinesType
> = z.nativeEnum(ListMyPipelinesType);

/** @internal */
export const ListMyPipelinesType$outboundSchema: z.ZodNativeEnum<
  typeof ListMyPipelinesType
...
/** @internal */
export const ListMyPipelinesState$inboundSchema: z.ZodNativeEnum<
  typeof ListMyPipelinesState
> = z.nativeEnum(ListMyPipelinesState);

/** @internal */
export const ListMyPipelinesState$outboundSchema: z.ZodNativeEnum<
  typeof ListMyPipelinesState
...
/** @internal */
export const ListMyPipelines4$inboundSchema: z.ZodType<
  ListMyPipelines4,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
export namespace ListMyPipelinesPipelineListResponse$ {
  ...
  export const inboundSchema =
    ListMyPipelinesPipelineListResponse$inboundSchema;
  /** @deprecated use `ListMyPipelinesPipelineListResponse$outboundSchema` instead. */
  export const outboundSchema =
    ListMyPipelinesPipelineListResponse$outboundSchema;
