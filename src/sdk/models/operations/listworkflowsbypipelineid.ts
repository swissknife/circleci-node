 ...
 * The current status of the workflow.
 */
export type ListWorkflowsByPipelineIdStatus = ClosedEnum<
 ...
 * Tag used for the workflow
 */
export type ListWorkflowsByPipelineIdTag = ClosedEnum<
...
export namespace ListWorkflowsByPipelineIdResponseBody$ {
  ...
  export const inboundSchema =
    ListWorkflowsByPipelineIdResponseBody$inboundSchema;
...
/** @internal */
export const ListWorkflowsByPipelineIdWorkflowListResponse$outboundSchema:
  z.ZodType<
...
export namespace ListWorkflowsByPipelineIdWorkflowListResponse$ {
  ...
  export const inboundSchema =
    ListWorkflowsByPipelineIdWorkflowListResponse$inboundSchema;
  /** @deprecated use `ListWorkflowsByPipelineIdWorkflowListResponse$outboundSchema` instead. */
  export const outboundSchema =
    ListWorkflowsByPipelineIdWorkflowListResponse$outboundSchema;
