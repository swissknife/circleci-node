 ...
 * The attribution-actor of the scheduled pipeline.
 */
export type UpdateScheduleAttributionActor = ClosedEnum<
 ...
 * Day in a week, in three letters format
 */
export type UpdateScheduleDaysOfWeek = ClosedEnum<
 ...
 * Day in a week, in three letters format
 */
export type UpdateScheduleScheduleDaysOfWeek = ClosedEnum<
 ...
 * Month, in three letters format.
 */
export type UpdateScheduleScheduleMonths = ClosedEnum<
...
/** @internal */
export const UpdateScheduleMonths$inboundSchema: z.ZodNativeEnum<
  typeof UpdateScheduleMonths
> = z.nativeEnum(UpdateScheduleMonths);

/** @internal */
export const UpdateScheduleMonths$outboundSchema: z.ZodNativeEnum<
  typeof UpdateScheduleMonths
...
export namespace UpdateScheduleUpdateScheduleParameters$ {
  ...
  export const inboundSchema =
    UpdateScheduleUpdateScheduleParameters$inboundSchema;
  /** @deprecated use `UpdateScheduleUpdateScheduleParameters$outboundSchema` instead. */
  export const outboundSchema =
    UpdateScheduleUpdateScheduleParameters$outboundSchema;
...
/** @internal */
export type UpdateScheduleScheduleParameters$Outbound =
  | number
  | string
  | boolean;
...
/** @internal */
export const UpdateScheduleScheduleResponseDaysOfWeek$inboundSchema:
  z.ZodNativeEnum<typeof UpdateScheduleScheduleResponseDaysOfWeek> = z
    .nativeEnum(UpdateScheduleScheduleResponseDaysOfWeek);

/** @internal */
export const UpdateScheduleScheduleResponseDaysOfWeek$outboundSchema:
  z.ZodNativeEnum<typeof UpdateScheduleScheduleResponseDaysOfWeek> =
...
export namespace UpdateScheduleScheduleResponseDaysOfWeek$ {
  ...
  export const outboundSchema =
    UpdateScheduleScheduleResponseDaysOfWeek$outboundSchema;
}

/** @internal */
export const UpdateScheduleScheduleResponseMonths$inboundSchema:
  z.ZodNativeEnum<typeof UpdateScheduleScheduleResponseMonths> = z.nativeEnum(
    UpdateScheduleScheduleResponseMonths,
  );

/** @internal */
export const UpdateScheduleScheduleResponseMonths$outboundSchema:
  z.ZodNativeEnum<typeof UpdateScheduleScheduleResponseMonths> =
...
export namespace UpdateScheduleScheduleResponseMonths$ {
  ...
  export const outboundSchema =
    UpdateScheduleScheduleResponseMonths$outboundSchema;
}

/** @internal */
export const UpdateSchedule2$inboundSchema: z.ZodType<
  UpdateSchedule2,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  months: z.array(UpdateScheduleScheduleResponseMonths$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  daysOfWeek: z.array(UpdateScheduleScheduleResponseDaysOfWeek$outboundSchema)
    .optional(),
  hoursOfDay: z.array(z.number().int()),
  months: z.array(UpdateScheduleScheduleResponseMonths$outboundSchema)
    .optional(),
...
/** @internal */
export const UpdateSchedule1$inboundSchema: z.ZodType<
  UpdateSchedule1,
  z.ZodTypeDef,
  unknown
> = z.object({
