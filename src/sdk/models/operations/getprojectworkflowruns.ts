 ...
 * Workflow status.
 */
export type GetProjectWorkflowRunsStatus = ClosedEnum<
...
> = z.object({
  ...
  "end-date": z.string().datetime({ offset: true }).transform(v => new Date(v))
    .optional(),
  "page-token": z.string().optional(),
  "project-slug": z.string(),
  "start-date": z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ).optional(),
...
/** @internal */
export const GetProjectWorkflowRunsInsightsResponseBody$inboundSchema:
  z.ZodType<GetProjectWorkflowRunsInsightsResponseBody, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const GetProjectWorkflowRunsInsightsResponseBody$outboundSchema:
  z.ZodType<
...
export namespace GetProjectWorkflowRunsInsightsResponseBody$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowRunsInsightsResponseBody$inboundSchema;
  /** @deprecated use `GetProjectWorkflowRunsInsightsResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowRunsInsightsResponseBody$outboundSchema;
...
export namespace GetProjectWorkflowRunsResponseBody$ {
  ...
  export const outboundSchema =
    GetProjectWorkflowRunsResponseBody$outboundSchema;
