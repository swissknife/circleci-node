...
/** @internal */
export const ProjectNames$inboundSchema: z.ZodType<
  ProjectNames,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const ReportingWindow$inboundSchema: z.ZodNativeEnum<
  typeof ReportingWindow
> = z.nativeEnum(ReportingWindow);

/** @internal */
export const ReportingWindow$outboundSchema: z.ZodNativeEnum<
  typeof ReportingWindow
...
export namespace GetOrgSummaryDataInsightsResponseBody$ {
  ...
  export const inboundSchema =
    GetOrgSummaryDataInsightsResponseBody$inboundSchema;
  /** @deprecated use `GetOrgSummaryDataInsightsResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    GetOrgSummaryDataInsightsResponseBody$outboundSchema;
