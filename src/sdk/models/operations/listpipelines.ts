 ...
 * The type of trigger.
 */
export type ListPipelinesPipelineType = ClosedEnum<
...
export type ListPipelinesTriggerParameters =
  | ListPipelines4
  | string
  | number
  | boolean;
...
export type Pipeline = {
  ...
  triggerParameters?: {
    [k: string]: ListPipelines4 | string | number | boolean;
  } | undefined;
  /**
...
/** @internal */
export const ListPipelinesType$inboundSchema: z.ZodNativeEnum<
  typeof ListPipelinesType
> = z.nativeEnum(ListPipelinesType);

/** @internal */
export const ListPipelinesType$outboundSchema: z.ZodNativeEnum<
  typeof ListPipelinesType
...
/** @internal */
export const ListPipelinesState$inboundSchema: z.ZodNativeEnum<
  typeof ListPipelinesState
> = z.nativeEnum(ListPipelinesState);

/** @internal */
export const ListPipelinesState$outboundSchema: z.ZodNativeEnum<
  typeof ListPipelinesState
...
/** @internal */
export const ListPipelinesVcs$inboundSchema: z.ZodType<
  ListPipelinesVcs,
  z.ZodTypeDef,
  unknown
> = z.object({
