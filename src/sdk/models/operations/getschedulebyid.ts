 ...
 * Month, in three letters format.
 */
export type GetScheduleByIdScheduleMonths = ClosedEnum<
 ...
 * Day in a week, in three letters format
 */
export type GetScheduleByIdDaysOfWeek = ClosedEnum<
...
export namespace GetScheduleByIdScheduleDaysOfWeek$ {
  ...
  export const outboundSchema =
    GetScheduleByIdScheduleDaysOfWeek$outboundSchema;
}
...
/** @internal */
export const GetScheduleById2$inboundSchema: z.ZodType<
  GetScheduleById2,
  z.ZodTypeDef,
  unknown
> = z.object({
  "days-of-month": z.array(z.number().int()),
  "days-of-week": z.array(GetScheduleByIdScheduleDaysOfWeek$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  daysOfWeek: z.array(GetScheduleByIdScheduleDaysOfWeek$outboundSchema)
    .optional(),
...
/** @internal */
export const GetScheduleByIdMonths$inboundSchema: z.ZodNativeEnum<
  typeof GetScheduleByIdMonths
> = z.nativeEnum(GetScheduleByIdMonths);

/** @internal */
export const GetScheduleByIdMonths$outboundSchema: z.ZodNativeEnum<
  typeof GetScheduleByIdMonths
...
/** @internal */
export const GetScheduleById1$inboundSchema: z.ZodType<
  GetScheduleById1,
  z.ZodTypeDef,
  unknown
> = z.object({
