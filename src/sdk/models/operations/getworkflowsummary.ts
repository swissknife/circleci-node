...
export namespace GetWorkflowSummaryInsightsResponseBody$ {
  ...
  export const inboundSchema =
    GetWorkflowSummaryInsightsResponseBody$inboundSchema;
  /** @deprecated use `GetWorkflowSummaryInsightsResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    GetWorkflowSummaryInsightsResponseBody$outboundSchema;
...
/** @internal */
export const DurationMetrics$inboundSchema: z.ZodType<
  DurationMetrics,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const Metrics$inboundSchema: z.ZodType<Metrics, z.ZodTypeDef, unknown> =
  z.object({
    ...
    window_end: z.string().datetime({ offset: true }).transform(v =>
      new Date(v)
    ),
