 ...
 * The time window used to calculate summary metrics. If not provided, defaults to last-90-days
 */
export type QueryParamReportingWindow = ClosedEnum<
...
export namespace GetProjectWorkflowJobMetricsRequest$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowJobMetricsRequest$inboundSchema;
  /** @deprecated use `GetProjectWorkflowJobMetricsRequest$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowJobMetricsRequest$outboundSchema;
...
/** @internal */
export const GetProjectWorkflowJobMetricsInsightsResponseBody$inboundSchema:
  z.ZodType<
    GetProjectWorkflowJobMetricsInsightsResponseBody,
    z.ZodTypeDef,
    unknown
...
/** @internal */
export const GetProjectWorkflowJobMetricsInsightsResponseBody$outboundSchema:
  z.ZodType<
...
export namespace GetProjectWorkflowJobMetricsInsightsResponseBody$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowJobMetricsInsightsResponseBody$inboundSchema;
  /** @deprecated use `GetProjectWorkflowJobMetricsInsightsResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowJobMetricsInsightsResponseBody$outboundSchema;
...
/** @internal */
export const GetProjectWorkflowJobMetricsDurationMetrics$inboundSchema:
  z.ZodType<
...
/** @internal */
export const GetProjectWorkflowJobMetricsDurationMetrics$outboundSchema:
  z.ZodType<
...
export namespace GetProjectWorkflowJobMetricsDurationMetrics$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowJobMetricsDurationMetrics$inboundSchema;
  /** @deprecated use `GetProjectWorkflowJobMetricsDurationMetrics$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowJobMetricsDurationMetrics$outboundSchema;
...
export namespace GetProjectWorkflowJobMetricsMetrics$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowJobMetricsMetrics$inboundSchema;
  /** @deprecated use `GetProjectWorkflowJobMetricsMetrics$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowJobMetricsMetrics$outboundSchema;
...
> = z.object({
  ...
  name: z.string(),
  window_end: z.string().datetime({ offset: true }).transform(v => new Date(v)),
  window_start: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ),
}).transform((v) => {
  return remap$(v, {
...
export namespace GetProjectWorkflowJobMetricsItems$ {
  ...
  export const outboundSchema =
    GetProjectWorkflowJobMetricsItems$outboundSchema;
...
> = z.object({
  items: z.array(
    z.lazy(() => GetProjectWorkflowJobMetricsItems$outboundSchema),
  ),
...
export namespace GetProjectWorkflowJobMetricsResponseBody$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowJobMetricsResponseBody$inboundSchema;
  /** @deprecated use `GetProjectWorkflowJobMetricsResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowJobMetricsResponseBody$outboundSchema;
...
export namespace GetProjectWorkflowJobMetricsResponse$ {
  ...
  export const inboundSchema =
    GetProjectWorkflowJobMetricsResponse$inboundSchema;
  /** @deprecated use `GetProjectWorkflowJobMetricsResponse$outboundSchema` instead. */
  export const outboundSchema =
    GetProjectWorkflowJobMetricsResponse$outboundSchema;
