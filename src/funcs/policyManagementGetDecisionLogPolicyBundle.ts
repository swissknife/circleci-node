 ...
 */
export async function policyManagementGetDecisionLogPolicyBundle(
    client$: CircleciCore,
    request: operations.GetDecisionLogPolicyBundleRequest,
    options?: RequestOptions
): Promise<
    Result<
        operations.GetDecisionLogPolicyBundleResponse,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetDecisionLogPolicyBundleRequest$outboundSchema.parse(value$),
    ...
    >(
        ...
        m$.json([400, 401, 403, 500], operations.GetDecisionLogPolicyBundleResponse$inboundSchema),
