...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.CreateContextRestrictionRequest$outboundSchema.parse(value$),
    ...
    >(
        ...
        m$.json([401, 404, 429, 500], operations.CreateContextRestrictionResponse$inboundSchema),
